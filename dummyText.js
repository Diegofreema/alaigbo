export const list = [
  {
    ...
    label: 'Who we are',
    description: `Alaigbo Youth Forum (AYF) is the driving force behind the transformation
...
Join us on this journey as we shape the future of Alaigbo and empower Ndigbo to reach new heights of success and prosperity.`,
...

  {
    ...
    label: 'Our Mission',
    description: `Empowering Minds, Advocating Change: Building a Sustainable Future for All`,
    content: [
...

  {
    ...
    label: 'Strategies Adopted to Achieve Our Vision and Mission:',
    description: ` "Embracing the Past, Empowering the Future: Uniting for Sustainable Success in Alaigbo!"`,
    content: [
